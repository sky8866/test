...
<nav class="text-right">
  <ul class="pagination">
    <li  <c:if test="${pageView.currentpage==pageView.pageindex.startindex}">  class="disabled"  </c:if>>
     ...
     <a href="javascript:topage1('${pageView.pageindex.startindex}')" aria-label="Previous">
    ...
    <c:if test="${pageView.currentpage!=wp}"> <li><a href="javascript:topage1('${wp}')">${wp}</a></li></c:if>
</c:forEach>
    
    <li <c:if test="${pageView.currentpage==pageView.pageindex.endindex}">  class="disabled"  </c:if>>
        <a href="javascript:topage1('${pageView.pageindex.endindex}')" aria-label="Next">
