        ...
        <div class="col-xs-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li   class="active" ><a href="#cateorder" data-toggle="tab" onClick="orderList(1)">酒店订单管理</a></li>
            ...
            <form class="form-inline">
             ...
             <div class="form-group">
				...
				<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="酒店、客房名称"
							id="query" name="query">
	   ...
	   (function ($) {
		 ...
		 function  orderList(page){
		  ...
		  $("#cateorder").append(qu); 
            ...
            $.ajax({                                                 
  		  type: "post",                                     
  		 url: "${basePath}/admin/ajax/hotel/order",                                      
  		 dataType: "html", 
  		 data: {page:page,status:status,query:query,starttime:starttime,endtime:endtime},
